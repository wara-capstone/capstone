  ...
  return (
    <div className="home">
      ...
      <Category
        ...
        allUrl={`${process.env.NODE_ENV === 'development' ? 'http:' : 'https:'}//${process.env.REACT_APP_API_URL}product/all/category/상의`}
        categoryUrl={`${process.env.NODE_ENV === 'development' ? 'http:' : 'https:'}//${process.env.REACT_APP_API_URL}product/all/category/`}
      />
      {/* <CardList /> */}
      <BottomNav />
    </div>
